...
class EmployeeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $employees = $em->getRepository('SiteSupervisionBundle:Employee')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SiteSupervisionBundle\Form\EmployeeType', $employee);
     ...
     *
     * @Route("/{id}/edit", name="employee_edit", defaults={"id" = 1})
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Employee $employee)
    {
        $deleteForm = $this->createDeleteForm($employee);
        $editForm = $this->createForm('SiteSupervisionBundle\Form\EmployeeType', $employee);
